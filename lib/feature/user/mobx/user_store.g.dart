...
mixin _$UserStore on _UserStore, Store {
  late final _$userListFutureAtom = Atom(name: '_UserStore.userListFuture', context: context);
  ...
  late final _$_UserStoreActionController = ActionController(name: '_UserStore', context: context);

  @override
  Future<List<User>> fetchUserList() {
    final _$actionInfo = _$_UserStoreActionController.startAction(name: '_UserStore.fetchUserList');
    try {
